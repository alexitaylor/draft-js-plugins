...
import Anchor from './components/pages/Anchor';
...
import MyInlineToolbar from './components/pages/MyInlineToolbar';
...
export const routes = (
  <Route path="/" title="App" component={App}>
    ...
    <Route path="/" title="App" component={Page}>
      ...
      <Route path="plugin/anchor" title="App - Anchor" component={Anchor} />
      ...
      <Route path="plugin/my-inline-toolbar" title="App - MyInlineToolbar" component={MyInlineToolbar} />
